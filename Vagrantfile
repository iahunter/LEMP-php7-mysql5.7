...
#Other Resource: https://github.com/Varying-Vagrant-Vagrants/VVV/issues/676
  ...
  #Notice that, vagrant will automatically assign IP to vagrant box. You can get this IP in two steps. Step 1: SSH into vagrant with command "vagrant ssh". Step 2: Run "ifconfig" on your SSH console and have a look at the eth1 device which should carry the VMs IP addres$
